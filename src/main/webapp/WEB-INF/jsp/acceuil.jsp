...
<html lang="fr">
  ...
  <body>
 		...
 		<div class="navbar navbar-expand-lg navbar-light">
	 		...
	 		<h1 id = "principal_tittle"><i class="fas fa-futbol"></i> Bête de Foot <i class="fas fa-futbol"></i></h1>
	...
	<div id="introduction">
		<div class="compartiment1">
			<p>
				...
				- établir de petis jeux de groupes que ce soit au sein d'entreprises ou de groupes d'amis.
			</p>
		</div>
		<div class="compartiment2"></div>
	</div>
	<div id="introduction2">	
		<div class="compartiment3"></div>
